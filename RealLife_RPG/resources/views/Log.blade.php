...
*/
    ...
    <style>
        #frame-0 .hljs-ln-line[data-line-number='46'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-1 .hljs-ln-line[data-line-number='265'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-2 .hljs-ln-line[data-line-number='211'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-3 .hljs-ln-line[data-line-number='808'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-4 .hljs-ln-line[data-line-number='169'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-6 .hljs-ln-line[data-line-number='208'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-7 .hljs-ln-line[data-line-number='50'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-8 .hljs-ln-line[data-line-number='208'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-9 .hljs-ln-line[data-line-number='126'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-14 .hljs-ln-line[data-line-number='200'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-15 .hljs-ln-line[data-line-number='169'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-24 .hljs-ln-line[data-line-number='109'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-26 .hljs-ln-line[data-line-number='61'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-32 .hljs-ln-line[data-line-number='26'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-34 .hljs-ln-line[data-line-number='126'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-35 .hljs-ln-line[data-line-number='175'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-36 .hljs-ln-line[data-line-number='144'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-37 .hljs-ln-line[data-line-number='1219'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-38 .hljs-ln-line[data-line-number='20'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-39 .hljs-ln-line[data-line-number='23'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
    </style>
</head>
                ...
                <section
                    ...
                    Error
                            ...
                            <div
                                ...
                                Call to undefined method App\Http\Controllers\DashBoard\User\UserController::delete()
                            </div>
                        </div>
                    ...
                    DELETE 127.0.0.1:8000
                            ...
                            <div class="px-4">
                                <span class="text-sm text-gray-500 dark:text-gray-400">PHP 8.4.4 — Laravel 12.21.0</span>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">App\Http\Middleware\AdminRoleMiddleware</span>
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\public\index.php</span>
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\vendor\laravel\framework\src\Illuminate\Foundation\resources\server.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\vendor\laravel\framework\src\Illuminate\Routing\ControllerDispatcher.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\vendor\laravel\framework\src\Illuminate\Routing\Route.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\vendor\laravel\framework\src\Illuminate\Routing\Router.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\vendor\laravel\framework\src\Illuminate\Pipeline\Pipeline.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\app\Http\Middleware\AdminRoleMiddleware.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\vendor\laravel\framework\src\Illuminate\Routing\Middleware\SubstituteBindings.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\vendor\laravel\framework\src\Illuminate\Foundation\Http\Kernel.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\vendor\laravel\framework\src\Illuminate\Foundation\Http\Middleware\TransformsRequest.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\vendor\laravel\framework\src\Illuminate\Foundation\Http\Middleware\ConvertEmptyStringsToNull.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\vendor\laravel\framework\src\Illuminate\Foundation\Http\Middleware\TrimStrings.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\vendor\laravel\framework\src\Illuminate\Http\Middleware\ValidatePostSize.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\vendor\laravel\framework\src\Illuminate\Foundation\Http\Middleware\PreventRequestsDuringMaintenance.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\vendor\laravel\framework\src\Illuminate\Http\Middleware\HandleCors.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\vendor\laravel\framework\src\Illuminate\Http\Middleware\TrustProxies.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\vendor\laravel\framework\src\Illuminate\Foundation\Http\Middleware\InvokeDeferredCallbacks.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\vendor\laravel\framework\src\Illuminate\Http\Middleware\ValidatePathEncoding.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\vendor\laravel\framework\src\Illuminate\Foundation\Application.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\public\index.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\vendor\laravel\framework\src\Illuminate\Foundation\resources\server.php</span>
...
require_once $publicPath.&#039;/index.php&#039;;
                ...
                <section
                    ...
                    <div class="mt-2">
                        <span>DELETE</span>
                        <span class="text-gray-500">/api/v1/admin/users/11</span>
                    </div>
                ...
                >
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">Bearer 12|tZDUtUvG0VkvOFgx2b6ZLDAALsM8DnEctrmJBj8409352481</code></pre>
                </span>
                        </div>
                ...
                >
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">PostmanRuntime/7.45.0</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <span
                ...
                >
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">9db1e789-f31c-4bc5-81f3-af4260cc745b</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <span
                ...
                >
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">129</code></pre>
                </span>
                        </div>
                    </dl>
            ...
            >
                ...
                <section
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">App\Http\Controllers\DashBoard\User\UserController@delete</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <span
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">api, admin.role:super,moderator</code></pre>
                </span>
                        </div>
                    </dl>
    ...
    &quot;id&quot;: &quot;11&quot;
                    ...
                    <dl class="mt-1 grid grid-cols-1 rounded border dark:border-gray-800">
                        <div class="flex items-center gap-2  dark:border-gray-800">
                            <div
                                ...
                                <span>mysql</span>
                                <span class="hidden text-xs text-gray-500 lg:inline-block">(9.42 ms)</span>
                            </div>
                            <span
                    class="min-w-0 flex-grow"
                    style="
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">select * from `personal_access_tokens` where `personal_access_tokens`.`id` = &#039;12&#039; limit 1</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <div
                                class="lg:text-md w-[8rem] flex-none truncate border-r px-5 py-3 text-sm dark:border-gray-800 lg:w-[12rem]">
                                <span>mysql</span>
                                <span class="hidden text-xs text-gray-500 lg:inline-block">(1.11 ms)</span>
                            </div>
                            <span
                    class="min-w-0 flex-grow"
                    style="
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">select * from `admins` where `admins`.`id` = 10001 and `admins`.`deleted_at` is null limit 1</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <div
                                class="lg:text-md w-[8rem] flex-none truncate border-r px-5 py-3 text-sm dark:border-gray-800 lg:w-[12rem]">
                                <span>mysql</span>
                                <span class="hidden text-xs text-gray-500 lg:inline-block">(3 ms)</span>
                            </div>
                            <span
                    class="min-w-0 flex-grow"
                    style="
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">update `personal_access_tokens` set `last_used_at` = &#039;2025-08-19 09:54:10&#039;, `personal_access_tokens`.`updated_at` = &#039;2025-08-19 09:54:10&#039; where `id` = 12</code></pre>
                </span>
                        </div>
                    </dl>
                </section>
