...
<script>
    window.translations = <?php echo json_encode([
        "errorLoading"     => __("lang.Unable_to_display_results"),
        "inputTooLong"     => __("Please delete "),
        "inputTooLong1"    => __("lang.character"),
        "inputTooShort"    => __("lang.Please_enter"),
        "loadingMore"      => __("lang.Loading_more_results"),
        "maximumSelected"  => __("lang.You_can_select"),
        "noResults"        => __("lang.No_results_found"),
        "searching"        => __("lang.Searching..."),
        "removeAllItems"   => __("lang.Remove_all"),
        "youHave"          => __("lang.You have"),
        "results"          => __("lang.results"),
    ]); ?>;
</script>
