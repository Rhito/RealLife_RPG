                        ...
                        <div class="kt-portlet__body">
                            <div class="kt-section kt-section--first">
                                ...
                                @if(in_array('lead_assign', $permissions))
                                        <?php
                                        $field = ['name' => 'saler_ids', 'type' => 'custom', 'field' => 'CRMDV.lead.form.saler_ids', 'label' => 'Sale phụ trách', 'model' => \App\Models\Admin::class, 'object' => 'admin', 'display_field' => 'name', 'multiple' => true, 'group_class' => 'col-md-12'];
                                        ?>
                                    <div class="form-group-div form-group {{ @$field['group_class'] }}"
                                         id="form-group-{{ $field['name'] }}">
                                        <label for="{{ $field['name'] }}">{{ @$field['label'] }} @if(strpos(@$field['class'], 'require') !== false)
