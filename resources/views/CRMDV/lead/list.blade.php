...
@include('CRMDV/partials/rut_ngan_ten')
<style>
    .ct-1 {
...
// dd($whereCreated_at);
    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="kt-portlet kt-portlet--mobile" style="width: 100%;">
                    ...
                    <div class="kt-portlet__head-wrapper">
                        <div class="dropdown show-columns-dropdown mr-1">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <hr class="dropdown-divider">
                                @php
                                    // Các field mặc định luôn hiển thị, không cho tick ẩn/hiện
                                    $defaultFields = ['name', 'rate', 'tel', 'sales'];
                                @endphp
                ...
                <div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--scroll kt-datatable--loaded"
                    ...
                    <table class="table table-striped">
                        ...
                        <tr class="kt-datatable__row" style="left: 0px;">
                            ...
                            <th data-field="company_id" data-column="sales"
...
@section('custom_head')
    ...
    <style type="text/css">
        ...
        @media (max-width: 768px) {
            ...
            .kt-portlet__head-label {
                position: relative; /* để nút bám theo block này */
            ...
            .show-columns-dropdown {
                ...
                top: 3%;
                left: 0 !important; /* sát mép trái */
            }

            .kt-portlet__head-label h3 {
                margin-right: 10px;    /* chừa chỗ cho nút, tránh đè chữ */
            }
            .lead-chart {
                display: flex;
                ...
                gap: 12px;               /* khoảng cách giữa các span/label */
                padding: 5px 0;
            }
            ...
            .lead-chart a {
                ...
                font-size: 13px;         /* chữ nhỏ gọn hơn trên mobile */
                margin-bottom: 0;
            }
    ...
    <style>
        ...
        .kt-datatable__body td[data-field="tel"]{
