                                    ...
                                    @else
                                        ...
                                        @else
                                            <div class="form-group-div form-group {{ @$field['group_class'] }}"
                                                ...
                                                <label for="{{ $field['name'] }}" class="dieptv-add-lead">{{ @$field['label'] }} @if(strpos(@$field['class'], 'require') !== false)
            ...
            <div class="col-xs-12 col-md-4">
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-form">
                        <div class="kt-portlet__body">
                            <div class="kt-section kt-section--first">
                                @foreach($module['form']['extend_tab'] as $field)
                                    @if(isset($field['view'] ) && $field['view'] == 'custom')
                                        @include($field['type'])
                                    @else
                                        @if($field['type'] == 'custom')
                                        ...
                                        @else
                                            <div class="form-group-div form-group {{ @$field['group_class'] }}"
                                                ...
                                                <label for="{{ $field['name'] }}">{{ @$field['label'] }} @if(strpos(@$field['class'], 'require') !== false)
                                                    ...
                                                    @endif
                                                    @if(!empty($field['link']))
                                                        <a href="{{ $field['link'] }}" class="btn-outline-primary p-1" target="_blank" >
