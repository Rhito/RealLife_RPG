                    ...
                    <div class="kt-portlet__head-wrapper">
                        <div class="">
                            <input type="text" name="quick_search" value="{{ @$_GET['quick_search'] }}"
                                   class="form-control" title=" {{ __('lang.Just_enter_to_perform_search') }}"
                                   placeholder="{{ __('lang.quick_search') }}">
                        </div>
                                ...
                                <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end"
                                    ...
                                    <ul class="kt-nav">
                                        <li class="kt-nav__section kt-nav__section--first">
                                            <span class="kt-nav__section-text">{{ __('lang.Choose_action') }}</span>
                                        </li>
                                        <li class="kt-nav__item">
                                            <a href="/admin/import/check-web-server" class="kt-nav__link"
                                               title="{{__('lang.Import_excel_file_to_push_data_into_the_system')}}">
                                        ...
                                        <li class="kt-nav__item">
                                            <a class="kt-nav__link export-excel"
                                               title="{{__('lang.Export_filtered_records_to_excel_file')}}"
                                               onclick="$('input[name=export]').click();">
                                                <i class="kt-nav__link-icon la la-file-excel-o"></i>
                                                <span class="kt-nav__link-text">{{ __('lang.Export_excel') }}</span>
                                            </a>
                                        </li>
                    ...
                    <div class="row">
                        ...
                        @foreach($filter as $filter_name => $field)
                            <div class="col-sm-6 col-lg-3 kt-margin-b-10-tablet-and-mobile list-filter-item">
                                <label>{{ __('lang.' . $field['label']) }}:</label>
