    ...
    <div class="kt-portlet__body">
        <div class="kt-widget12">
            <div class="kt-widget12__content">
                ...
                <div class="kt-widget12__item thong_ke_so">
                    <div class="col-sm-3 kt-widget12__info">
                        <span class="kt-widget12__desc">Tổng doanh số</span>
                        <span class="kt-widget12__value">{{number_format($doanh_so, 0, '.', '.')}}</span>
                    </div>
                    =
                    <div class="col-sm-3 kt-widget12__info">
                        <span class="kt-widget12__desc">Doanh số HBweb</span>
                        <span class="kt-widget12__value">{{number_format(\App\CRMDV\Models\Bill::whereNotIn('service_id', [
                                        23, //  web khác
                                        24,
                                        25,
                                    ])->whereRaw($whereRegistration)->sum('total_price'), 0, '.', '.')}}</span>
                    </div>
                    +
                    <div class="col-sm-3 kt-widget12__info">
                        <span class="kt-widget12__desc">Doanh số Hobasoft</span>
                        <span class="kt-widget12__value">{{number_format(\App\CRMDV\Models\Bill::whereIn('service_id', [
                                        23, //  web khác
                                        24,
                                        25,
                                    ])->whereRaw($whereRegistration)->sum('total_price'), 0, '.', '.')}}</span>
                ...
                <div class="kt-widget12__item thong_ke_so">
                    <div class="col-sm-3 kt-widget12__info">
                        <span class="kt-widget12__desc">DS duy trì</span>
                        <span class="kt-widget12__value">{{number_format(\App\CRMDV\Models\Bill::whereIn('service_id', [
                                        7,
                                        25,
                                    ])->whereRaw($whereRegistration)->sum('total_price'), 0, '.', '.')}}</span>
                    ...
                    <div class="col-sm-3 kt-widget12__info">
                        <span class="kt-widget12__desc">DS WP/LDP ký mới</span>
                        <span class="kt-widget12__value">{{number_format(\App\CRMDV\Models\Bill::whereIn('service_id', [
                                        1, //  web khác
                                        5,
                                        10,
                ...
                <div class="kt-widget12__item thong_ke_so">
                    <div class="col-sm-3 kt-widget12__info">
                        <span class="kt-widget12__desc font-vua">Doanh thu dự án</span>
