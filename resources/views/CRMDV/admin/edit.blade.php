                    ...
                    <div class="kt-portlet__head kt-portlet__head--lg" style="">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            ...
                            <a href="/admin/profile/{{ $result->id }}/login" class="btn btn-clean kt-margin-r-10">
                                ...
                                <span class="kt-hidden-mobile">{{__('lang.login_to_this_account')}}</span>
                            </a>
                            @endif
                        ...
                        <div class="kt-portlet__body">
                            <div class="kt-section kt-section--first">
                                ...
                                @if(in_array('role_view', $permissions))
                                        <?php
                                        $field = ['name' => 'role_id', 'type' => 'custom', 'field' => 'CRMDV.admin.partials.select_role', 'label' => __('lang.role'), 'class' => 'required', 'model' => \App\Models\Roles::class, 'display_field' => 'display_name'];
                                        $field['value'] = @$result->{$field['name']};
                                        ?>
                                    <div class="form-group-div form-group {{ @$field['group_class'] }}"
                                         id="form-group-{{ $field['name'] }}">
