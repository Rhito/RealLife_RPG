                        ...
                        @foreach($listItem as $item)
                            ...
                            <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                                ...
                                <td> {{--Hiển thị thông tin lỗi chưa điền link hợp đồng hoặc chưa xuất hoá đơn--}}
                                        ...
                                        <?php
                                        $bill_receipts = \App\CRMDV\Models\BillReceipts::where('bill_id', $item->id)->where('receiving_account', 'ACB 2288668668')->get();
                                    ...
                                    @if((count($bill_receipts) > 0 && $item->link_hd == null) || (count($bill_receipts) > 0 && $item->hd_luu_tru == null))
                                        <span title="Chưa điền link HĐ">H.đồng</span>,
                                    @endif
                                    @if($chua_dien_so_hoa_don) <span title="Chưa điền số hoá đơn">H.đơn</span>@endif
