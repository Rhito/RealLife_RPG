                ...
                <div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--scroll kt-datatable--loaded"
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody class="kt-datatable__body ps ps--active-y" style="max-height: 496px;">
                            <?php
                            $day = date('d');
                            $ignore_links = \App\Models\Setting::where('name', 'ignore_links')->where('type', 'check_link_error')->first();
                            ?>
                        @foreach($listItem as $item)
                            @if (!in_array($item->bill->service_id, [
                                    3,  //  tên miền
                                    4,  //  mail
                                    6,  //  khác
                                    22, // thiết kế ảnh
                                ...
                                @if (strpos($ignore_links->value, $item->links) === false)
