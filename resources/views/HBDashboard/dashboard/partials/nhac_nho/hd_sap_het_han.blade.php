                        ...
                        @if($bill_warning->count()>0)
                            ...
                            @foreach($bill_warning as $k=>$v)
                                @if(strtotime($v->expiry_date) < time())
                                    <tr style="border-bottom: 1px solid #e8ecef; transition: all 0.3s ease; background: tomato;"
                                        ...
                                        onmouseout="this.style.backgroundColor='tomato'; this.style.transform='translateX(0)'; this.style.boxShadow='none'">
                        ...
                        @if($bill_warning->count()>0)
                            @foreach($bill_warning as $k=>$v)
                                ...
                                @if(strtotime($v->expiry_date) >= time() && $day_check <= $cau_hinh['close_day'])
                                    <tr style="border-bottom: 1px solid #e8ecef; transition: all 0.3s ease; background: lightsalmon;"
                                        onmouseover="this.style.backgroundColor='#e3f2fd'; this.style.transform='translateX(4px)'; this.style.boxShadow='0 2px 8px rgba(0,0,0,0.1)'"
                                        onmouseout="this.style.backgroundColor='lightsalmon'; this.style.transform='translateX(0)'; this.style.boxShadow='none'">
                                        <td style="padding: 16px; vertical-align: middle; border: none;">
