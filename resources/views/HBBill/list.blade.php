                        ...
                        @foreach($listItem as $item)
                            ...
                            <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                                ...
                                <td> {{--Hiển thị thông tin lỗi chưa điền link hợp đồng hoặc chưa xuất hoá đơn--}}
                                    ...
                                    <?php
                                        $bill_receipts = \App\Modules\HBBill\Models\BillReceipts::where('bill_id', $item->id)->where('receiving_account', 'ACB 2288668668')->get();
                                        ...
                                        ?>
                                    @if(count($bill_receipts) > 0 && $item->link_hd == null)
                                        Chưa điền link HĐ |
                                    @endif
                                    @if($chua_dien_so_hoa_don) Chưa điền số hoá đơn | @endif
