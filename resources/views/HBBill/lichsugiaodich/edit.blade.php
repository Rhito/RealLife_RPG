...
@section('main')
    ...
    <form class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid {{ @$module['code'] }}"
                    ...
                    <div class="kt-portlet__head kt-portlet__head--lg" style="">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Chỉnh
                                sửa {{ __($module['label']) }} {{ @$services[$result->service_id] }}
                            </h3>
                        </div>
            ...
            <div class="col-xs-12 col-md-8">
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-form">
                        <div class="kt-portlet__body">
                            <div class="kt-section kt-section--first">
                                @foreach($module['form']['contract_tab'] as $field)
                                    @php
                                        $field['value'] = @$result->{$field['name']};
                                    @endphp
                                    <div class="form-group-div form-group {{ @$field['group_class'] }}"
        ...
        <div class="row">
            <div class="col-xs-12 col-md-8">
                <!--begin::Portlet-->
                @include('HBBill.form.fields.thong_tin_thanh_toan')
            ...
            <div class="col-xs-12 col-md-4">
                @if(@$result->bill_parent == null)
                    ...
                    @include('HBBill.form.fields.phu_luc_hd')
                @endif
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-form">
                        <div class="kt-portlet__body">
                            <div class="kt-section kt-section--first">
                                <?php
                                    $bill_process = \App\Modules\HBBill\Models\BillProgress::select(['id', 'dh_id', 'kt_id', 'status'])->where('bill_id', $result->id)->first();
                                    ?>
                                Điều hành: {{ @\App\Models\Admin::find($bill_process->dh_id)->name }}<br>
                                Kỹ thuật: {{ @\App\Models\Admin::find($bill_process->kt_id)->name }}<br>
                                Tiến độ: {{ @$bill_process->status }}<br>
                                <a href="/admin/dhbill/edit/{{ $result->id }}" target="_blank">Xem chi tiết triển khai</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
                ...
                <div class="kt-portlet">
                    <div class="kt-form">
                        <div class="kt-portlet__body">
                            ...
                            <div class="log_logs">
                                <?php
                                $logs = \App\Modules\HBBill\Models\LeadContactedLog::where('type', 'hđ')->where('lead_id', @$result->id)->orderBy('id', 'desc')->get();
                                ?>
                                @foreach($logs as $log)
                                    <hr>
                                ...
                                <div class="log-item"  style="color: #000;">
                                    ...
                                    <i style="font-size: 11px;">{{ date('H:i d/m/Y', strtotime($result->created_at)) }}
                                        - Bởi: {!! @$result->admin->name !!}{{ $result->admin_id }}</i>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xs-12 col-md-4">
                @include('HBBill.bill.partials.dich_vu_lien_quan', ['customer_id' => $result->customer_id, 'bill_id' => $result->id])
            </div>
        </div>
    </form>
