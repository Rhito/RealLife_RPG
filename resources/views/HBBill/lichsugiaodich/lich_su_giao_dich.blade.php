                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <p><strong>{{ __('lang.Payment_Methods') }}:</strong> {{$item->tinh_trang_thanh_toan_text}}</p>
                                                            <p><strong>{{ __('lang.Trang_thai_mua') }}:</strong> <span class="badge badge-success">{{$item->status_text}}</span></p>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <p><strong>{{ __('lang.Tinh_trang_hau_can') }}:</strong> {{$item->tinh_trang_thanh_toan_text}}</p>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <p><strong>{{ __('lang.Ten') }}:</strong> <span class="item-user_id">{{$item->admin->name}}</span></p>
                                                            <p><strong>{{ __('lang.dia_chi') }}:</strong> <span class="item-user_id">{{$item->admin->tel}}</span></p>
                                                            <p><strong>{{ __('lang.quoc_gia') }}:</strong> United States</p>
                                                            <p><strong>{{ __('lang.thanh_pho') }}:</strong> Omaha</p>
                                                        </div>
                                                        <div class="col-md-6">
                                                            ...
                                                            <p><strong>{{ __('lang.tinh_va_quan_huyen') }}:</strong> Nebraska</p>
                                            ...
                                            <div class="card mb-3">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row align-items-center border-bottom py-2">
                                                        <div class="col-2">
                                                            <img src="{{ CommonHelper::getUrlImageThumb($item->product->image) }}" alt="Ảnh sản phẩm" class="img-fluid">
                                                        </div>
                                                        <div class="col-3">{{$item->product->ma_san_pham}}</div>
