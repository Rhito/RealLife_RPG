                                    ...
                                    <ul class="kt-nav">
                                        ...
                                        <li class="kt-nav__item">
                                            <a href="/admin/import/add?table=products&amp;table_label=Sản phẩm" class="kt-nav__link" title="Nhập file excel lên để đẩy dữ liệu vào hệ thống">
                                                ...
                                                <span class="kt-nav__link-text">Nhập Excel</span>
                                            </a>
                                        </li>
                                        ...
                                        <li class="kt-nav__item">
                                            <a href="javascript:void(0);" class="kt-nav__link" title="Xóa tất cả các dòng" onclick="deleteAllRecords()">
                                                <i class="kt-nav__link-icon la la-copy"></i>
                                                <span class="kt-nav__link-text">Xóa tất cả</span>
                                            </a>
                                        </li>
