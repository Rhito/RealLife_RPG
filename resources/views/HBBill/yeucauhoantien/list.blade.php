                                    ...
                                    <ul class="kt-nav">
                                        ...
                                        <li class="kt-nav__item">
                                            <a class="kt-nav__link export-excel"
                                               title="{{'lang.Export the filtered records to an Excel file'}}"
...
{{--                                        @endif--}}
                            ...
                            <a  href="{{route('yeuCauHoanDiemAdd')}}"
                    ...
                    <div class="row">
                        ...
                        @foreach($filter as $filter_name => $field)
                            ...
                            <div class="col-sm-6 col-lg-3 kt-margin-b-10-tablet-and-mobile list-filter-item">
                                ...
                                @include(config('core.admin_theme').'.list.filter.' . $field['type'], [
                                    'name'  => $filter_name,
                                    'field' => $field
                                ])
                            </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tr class="kt-datatable__row" style="left: 0px;">
                            ...
                            @foreach($module['list'] as $field)
                                ...
                                @php if(isset($field['sort']) && $field['sort']){ @endphp onclick="sort('{{ $field['name'] }}')" @php } @endphp>
                                    {{ __($field['label']) }}
                        ...
                        @foreach($listItem as $item)
                            <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                                ...
                                @if (in_array(CommonHelper::getRoleName(\Auth::guard('admin')->user()->id, 'name'), ['super_admin']))
                                    <td> <a class="btn btn-danger" href="{{route('yeu_cau_hoan_tien.edit',$item->id)}}" >{{__('lang.edit')}}</a> </td>
                                @endif
