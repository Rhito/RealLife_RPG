                        ...
                        <div class="kt-portlet__body">
                            <div class="log_action">
                                ...
                                <div class="form-group-div form-group col-md-12" id="form-group-name">
                                    ...
                                    @endif
                                    @include('HBBill.lead.form.partials.nut_submit_ls_tu_van')
                                </div>
                            </div>

                            <div class="log_logs">
                                <?php 
                            $logs = \App\Modules\HBBill\Models\LeadContactedLog::where('type', 'lead')->where('lead_id', @$result->id)->orderBy('id', 'desc')->get();
                            ?>
                            @foreach($logs as $log)
                            <hr>
