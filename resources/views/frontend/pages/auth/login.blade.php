...
@section('content')
    <style>
        .rigister-content-tab .el-button.active {
    ...
    <div class="app-container app-center">
        ...
        <div class="login-content">
            <div class="el-row" style="margin-left: -10px; margin-right: -10px;">
                ...
                <!-- Left Banner -->
                <div class="el-col el-col-24 el-col-xs-0 el-col-sm-12 el-col-md-12 el-col-lg-12 el-col-xl-12"
                     style="padding-left: 10px; padding-right: 10px;">
                    <div class="login-content-left flex-center">
                        <img src="{{ asset('filemanager/userfiles/loginBg.2e4a973c.png') }}" alt="login" class="login-content-banner">
                    </div>
                </div>
                ...
                <div class="el-col el-col-24 el-col-xs-24 el-col-sm-12 el-col-md-12 el-col-lg-12 el-col-xl-12"
                    ...
                    <div class="login-content-right">
                        <h1>{{__('lang.log_in')}}</h1>


                        <div class="rigister-content-tab">
                            <button type="button" id="tabEmail" class="el-button active">Email</button>
                            <button type="button" id="tabPhone" class="el-button">{{__('lang.mobile_number')}}</button>
                        </div>

                        <div class="login-content-form">
                            <!-- Form đăng nhập bằng Email -->
                            <form action="" method="POST" class="el-form el-form--label-top" id="formEmail">
                                <div class="el-form-item is-required">
                                    <label for="email" class="el-form-item__label">Email</label>
                                    <div class="el-form-item__content">
                                        <div class="el-input">
                                            <input type="email" id="email" name="email" value="{{ old('email') }}"
                                                   placeholder="{{__('lang.please_enter_your_email')}}" class="el-input__inner" required>
                                        </div>
                                ...
                                <div class="el-form-item mt-4">
                                    <div class="el-form-item__content">
                                        <button type="submit" class="el-button sing-in-btn el-button--primary">
                                            <span>{{__('lang.log_in')}}</span>
                                        </button>
                                    </div>
                                </div>
                            </form>
                            ...
                            <form action="" method="POST" class="el-form el-form--label-top hidden" id="formPhone">
                                <div class="el-form-item is-required">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            if (savedTab) {
                ...
                activateTab('email'); // mặc định là email
            }
        });
    </script>
