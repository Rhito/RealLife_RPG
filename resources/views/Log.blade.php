...
*/
    ...
    <style>
        #frame-0 .hljs-ln-line[data-line-number='7'] {
                ...
                <section
                    ...
                    FatalError
                            ...
                            <div
                                ...
                                Class App\Repositories\Task\TaskRepository contains 4 abstract methods and must
                                therefore be declared abstract or implement the remaining methods
                                (App\Repositories\Contracts\TaskRepositoryInterface::create,
                                App\Repositories\Contracts\TaskRepositoryInterface::update,
                                App\Repositories\Contracts\TaskRepositoryInterface::delete, ...)
                            </div>
                        </div>
                        ...
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\app\Repositories\Task\TaskRepository.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">C:\Laravel\RealLife_RPG\app\Repositories\Task\TaskRepository.php</span>
...
{
    public function paginateWithQuery(int $perPage, ?string $search, ?string $status, string $sortBy, string $sortDirection) {}
    public function findOrFail(int $id, bool $withTrashed = false): mixed {}
                ...
                <section
                    ...
                    <div class="mt-2">
                        <span>GET</span>
                        <span class="text-gray-500">/api/v1/admin/tasks</span>
                    </div>
                ...
                >
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">Bearer 21|VnaRNWqkrK9hHUAk7NoOoFfG7t1W5TaN8abnrMpw43319f36</code></pre>
                </span>
                        </div>
                ...
                >
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">c568edb4-47f2-405b-82b9-cfb9e2cbc534</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <span
    ...
    &quot;sortDriection&quot;: &quot;asc&quot;
                ...
                <section
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">App\Http\Controllers\DashBoard\Task\TaskController@index</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <span
                ...
                >
                    ...
                    <dl class="mt-1 grid grid-cols-1 rounded border dark:border-gray-800">
                        <div class="flex items-center gap-2  dark:border-gray-800">
                            <div
                                ...
                                <span>mysql</span>
                                <span class="hidden text-xs text-gray-500 lg:inline-block">(2.37 ms)</span>
                            </div>
                            <span
                    class="min-w-0 flex-grow"
                    style="
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">select * from `personal_access_tokens` where `personal_access_tokens`.`id` = &#039;21&#039; limit 1</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <div
                                class="lg:text-md w-[8rem] flex-none truncate border-r px-5 py-3 text-sm dark:border-gray-800 lg:w-[12rem]">
                                <span>mysql</span>
                                <span class="hidden text-xs text-gray-500 lg:inline-block">(0.47 ms)</span>
                            </div>
                            <span
                    class="min-w-0 flex-grow"
                    style="
                ...
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">select * from `admins` where `admins`.`id` = 10001 and `admins`.`deleted_at` is null limit 1</code></pre>
                        ...
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <div
                                class="lg:text-md w-[8rem] flex-none truncate border-r px-5 py-3 text-sm dark:border-gray-800 lg:w-[12rem]">
                                <span>mysql</span>
                                <span class="hidden text-xs text-gray-500 lg:inline-block">(7.22 ms)</span>
                            </div>
                            <span
                    class="min-w-0 flex-grow"
                    style="
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">update `personal_access_tokens` set `last_used_at` = &#039;2025-08-29 07:33:51&#039;, `personal_access_tokens`.`updated_at` = &#039;2025-08-29 07:33:51&#039; where `id` = 21</code></pre>
                </span>
                        </div>
                    </dl>
                </section>
